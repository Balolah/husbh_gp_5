...
void main() {
  ...
  runApp(subtractionVideo());
}

// ignore: camel_case_types
class subtractionVideo extends StatefulWidget {
  const subtractionVideo({Key? key}) : super(key: key);
  @override
  _VideoAppState createState() => _VideoAppState();
}

class _VideoAppState extends State<subtractionVideo> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/subtraction.mp4')
      ..initialize().then((_) {
        ...
        timer = Timer(
            ...
            () => Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => const subtractionQuizScreen(),
                )));
