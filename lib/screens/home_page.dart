                      ...
                      NiceButtons(
                          ...
                          onTap: (finish) {
                            AwesomeDialog(
                              ...
                              body: const Center(
                                  child: Text(
                                      'حٌسبة \nهو تطبيق لتعليم الاطفال العمليات الحسابية وجعل عملية التعليم ممتعة باستخدام الواقع المعزز في مجال الالعاب. قم باختيار احدى العمليات الحسابية ولنبدأ التعلم معاً',
